...
(function () {
    ...
    var hig=document.querySelectorAll('.docs-header')[0];
    var w = window.innerWidth-20;
    var h = hig.offsetHeight;
    var max = 100;
    var _x = 0;
    var _y = 0;
    var _z = 150;
    ...
    (function() {
        ...
        Build.prototype.go = function() {
            ...
            this.canvas.height = hig.offsetHeight;
        ...
        Build.prototype.run = function() {
            ...
            hig.addEventListener('mousemove', function(e) {
                this.toX = (e.clientX - this.canvas.width / 2) * -0.8;
                this.toY = (e.clientY - this.canvas.height / 2) * 0.8;
            }.bind(this));
            hig.addEventListener('touchmove', function(e) {
                e.preventDefault();
